...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/20-03-2018/events-demo_Free/1266549478/web/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 May 2018 04:06:46 GMT -->
...
<div class="header-w3layouts"> 
    ...
    text-transform: uppercase;">Logout</a></li>                              
                       ...
                       <?php } ?>
							...
							<li id="cont"><a class="hvr-sweep-to-right active" href="contact.php">Contact</a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
				</div>
		...
		<div class="col-md-6 contact-form">
			...
			<div class="col-md-6 contactright">
				...
				<div class="w3ls_footer_grid_left">
					...
					<p>Sector 8,Near Ambika Shopping Centre,<span> Nerul, Navi Mumbai,400706</span></p>
				</div>
				<div class="w3ls_footer_grid_left">
					<div class="wthree_footer_grid_left">
					...
					<p>+91 9607883883</p>
					<span>+91 8678903216</span>
				</div>
				<div class="w3ls_footer_grid_left">
					<div class="wthree_footer_grid_left">
						<i class="fa fa-envelope-o" aria-hidden="true"></i>
					</div>
					<p><a href="mailto:info@example.com">abc@gmail.com</a> 
						<span><a href="mailto:info@example.com">abhydas28@gmail.com</a></span></p>
				</div>
			</div>
